...
- Locality-based restaurant insights
- Rating analysis
...
## Project Structure
- pydatanalysis.py → Main analysis script
...
2. Download Uncleaned Dataset from links provided above and place it in project folder.
